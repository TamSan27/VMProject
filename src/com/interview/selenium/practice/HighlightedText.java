...
public class HighlightedText {
	...
	WebElement element1=driver.findElement(By.xpath("//table/tbody/tr/td[text()='Mexico']"));
	...
	/*
	 * WebElement higlightedEle = driver.findElement(By.
	 * xpath("//div[@class='w3-white w3-padding notranslate w3-padding-16']//following-sibling::a[text()='Try it Yourself �']"
	 * )); String clr3 = higlightedEle.getCssValue("color");
	 * System.out.println("print the colour of the text:"+clr3); String backclr3 =
	 * higlightedEle.getCssValue("background-color");
	 * System.out.println("print the colour of the text:"+backclr3); String bold3 =
	 * higlightedEle.getCssValue("font-weight");
